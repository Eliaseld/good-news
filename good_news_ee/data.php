<?php
  ...
  // is coming from, be it a textfile, a database or as in this example
  // a hard coded array.
  // As long as the data is put in to an array the site will work.
  // Eh, almost... since the keys are hard coded the data has to be in the
  // same format as seen below.
  $articles = [
    ...
    [
      ...
      'content' => 'Lorem Ipsum är en utfyllnadstext från tryck- och
        ...
        göra ett provexemplar av en bok. Lorem ipsum har inte bara överlevt fem
    ...
    [
      ...
      'content' => 'I motsättning till vad många tror, är inte Lorem Ipsum
        ...
        McClintock, en professor i latin på Hampden-Sydney College i Virginia,
        översatte ett av de mer ovanliga orden, consectetur, från ett stycke
        Lorem Ipsum och fann dess ursprung genom att studera användningen av
        dessa ord i klassisk litteratur. Lorem Ipsum kommer från styckena
        1.10.32 och 1.10.33 av "de Finibus Bonorum et Malorum"
        (Ytterligheterna av ont och gott) av Cicero, skriven 45 före år 0.
        Boken är en avhandling i teorier om etik, och var väldigt populär under
        renäsanssen. Den inledande meningen i Lorem Ipsum, "Lorem Ipsum dolor
        sit amet...", kommer från stycke 1.10.32.
        Den ursprungliga Lorem Ipsum-texten från 1500-talet är återgiven nedan
    ...
    [
      ...
      'content' => 'Det är ett välkänt faktum att läsare distraheras av läsbar
        ...
        webbutvecklare använder Lorem Ipsum som test-text, och en sökning efter
    ...
    [
      ...
      'content' => 'Det finns många olika varianter av Lorem Ipsum,
        ...
        använda långa stycken av Lorem Ipsum bör man försäkra sig om att det inte
        gömmer sig något pinsamt mitt i texten. Lorem Ipsum-generatorer på internet
        tenderar att repetera Lorem Ipsum-texten styckvis efter behov, något som
        gör denna sidan till den första riktiga Lorem Ipsum-generatorn på internet.
        Den använder ett ordförråd på över 200 ord, kombinerat med ett antal
    ...
    [
      'title' => 'Idag minns vi Jan Jansson ett år efter tragedin',
      'content' => 'Lorem Ipsum är en utfyllnadstext från tryck- och
        förlagsindustrin. Lorem ipsum har varit standard ända sedan 1500-talet,
        när en okänd boksättare tog att antal bokstäver och blandade dem för att
        göra ett provexemplar av en bok. Lorem ipsum har inte bara överlevt fem
    ...
    [
      'title' => 'Fine, jag ska sluta med clickbait...',
      'content' => 'I motsättning till vad många tror, är inte Lorem Ipsum
        slumpvisa ord. Det har sina rötter i ett stycke klassiskt litteratur på
        latin från 45 år före år 0, och är alltså över 2000 år gammalt. Richard
        McClintock, en professor i latin på Hampden-Sydney College i Virginia,
    ...
    [
      'title' => 'Tre anledningar till varför kaninerna är rättvisa härskare',
      'content' => 'Det finns många olika varianter av Lorem Ipsum,
        men majoriteten av dessa har ändrats på någotvis. Antingen med inslag av
        humor, eller med inlägg av ord som knappast ser trovärdiga ut. Skall man
        använda långa stycken av Lorem Ipsum bör man försäkra sig om att det inte
    ...
    [
      'title' => 'Jan Jansson funnen död, morot mördarvapnet?',
      'content' => 'Det är ett välkänt faktum att läsare distraheras av läsbar
        text på en sida när man skall studera layouten. Poängen med Lorem Ipsum är
        att det ger ett normalt ordflöde, till skillnad från "Text här, Text här",
        och ger intryck av att vara läsbar text. Många publiseringprogram och
